...
var appSpaRoot = Path.Combine(app.Environment.WebRootPath ?? "wwwroot", "app");
if (Directory.Exists(appSpaRoot))
{
    var appSpaFiles = new PhysicalFileProvider(appSpaRoot);
    app.UseDefaultFiles(new DefaultFilesOptions
    {
        FileProvider = appSpaFiles,
        RequestPath = "/app",
    });
